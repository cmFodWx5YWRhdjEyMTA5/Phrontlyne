          ...
          <section class="vbox">          
            <section class="scrollable padder">
              <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li >Reports</li>
                <li class="active">Installments Report</li>
              </ul>
            
              <div class="col-lg-12">
                  <h2 class="font-thin">Installments  Report</h2>
                </div>
                ...
                <div class="panel-body">
                  <form class="form-horizontal" method="get">
                    <div class="form-group">
                      <label class="col-sm-2 control-label">INSTALLMENT PERIOD </label>
                      <div class="col-sm-10">
                    ...
                    <div class="line line-dashed line-lg pull-in"></div>
                     <div class="form-group">
                      <label class="col-sm-2 control-label">INSTALLMENT TYPE</label>
                      <div class="col-sm-10">
                        <input type="text" readonly="true" value="" class="form-control rounded">                        
                      </div>
                    </div>
