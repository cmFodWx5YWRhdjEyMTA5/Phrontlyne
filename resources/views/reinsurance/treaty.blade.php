                  ...
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                   ...
                   <img src="/images/258401.png" width="15%" class="pull-left">
                    <a class="clear" href="/reinsurance-businesses"  data-toggle="modal" class="btn btn-sm btn-default bootstrap-modal-form-open">
                      ...
                      <small class="text-muted text-uc">FAC Businesses</small>
                    </a>
                  </div>
                    ...
                    <a class="clear" href="/payment-index">
                      ...
                      <small class="text-muted text-uc">Ceded FAC Businessed</small>
                    </a>
                  </div>
                    <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                    ...
                    <a class="clear" href="/insurance-claims">
                      <span class="h3 block m-t-xs"><strong>0</strong></span>
                      <small class="text-muted text-uc">FAC Payments</small>
                    </a>
                  </div>
                   <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  {{-- <header class="panel-heading">
                    ...
                    <header class="panel-heading">
                    <form action="/find-reinsurance-treaty" method="GET">
                      <div class="input-group text-ms">
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table table-striped m-b-none text-sm" width="100%">
                        ...
                        @endif
                            ...
                            <td><a href="/view-cession-treaty/{{ $reinsurance->cession_number }}" class="bootstrap-modal-form-open"  id="edit" name="edit" data-toggle="modal" alt="edit"><i class="fa fa-folder-open-o"></i></a></td>
