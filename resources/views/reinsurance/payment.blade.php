                    ...
                    <div class="form-group pull-in clearfix">
                     ...
                     <header class="panel-heading font-bold">                  
                      ...
                      <div class="panel-body">
                        ...
                        <select id="reference_name" name="reference_name" rows="3" tabindex="1" data-placeholder="Select here.." style="width:100%" data-required="true">
                       ...
                       @endforeach
                        ...
                        <div class="form-group pull-in clearfix">
                          ...
                          <div class="form-group{{ $errors->has('cash_receipt_number') ? ' has-error' : ''}}">
                            <label> Cheque No. / Swift No. </label>
