...
<div style="margin-top: 10px;">To use {{ $company->name }} , we take account security very seriously. Here is how to make it hard for your {{ $company->name }}  user account to fall into wrong hands.</div>
