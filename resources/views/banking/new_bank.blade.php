<section class="panel panel-default">
                      ...
                      <div class="form-group pull-in clearfix">
                          <div class="col-sm-12">
                            ...
                            <input type="text" rows="3" class="form-control" data-required="true" id="bank_name" name="bank_name" value="{{ Request::old('bank_name') ?: '' }}">   
                      ...
                      <footer class="panel-footer text-right bg-light lter">
                        <button type="submit" class="btn btn-success btn-s-xs">Save Bank</button>
                      </footer>
                      </section>
