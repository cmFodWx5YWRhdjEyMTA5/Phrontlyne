...
<section id="content">
          <section class="vbox">          
            <section class="scrollable padder">
              ...
              <p class="h4 text-dark"><strong>New Policy : {{ $customers->fullname }} ( {{ $customers->account_number }} )</strong></p>
            </header>
                    ...
                    {{-- Step 1 Start --}}
                      ...
                      <div class="form-group pull-in clearfix">
                        ...
                        <div class="form-group{{ $errors->has('customer_number') ? ' has-error' : ''}}">
                          ...
                          <input type="text" class="form-control" id="fullname" required="" name="fullname" value="{{$customers->fullname}}" readonly="true">
                          ...
                          <div class="form-group{{ $errors->has('policy_product') ? ' has-error' : ''}}">
                             <select id="policy_product" name="policy_product" rows="3" data-required="true" tabindex="1" data-placeholder="Select here.." style="width:100%" onchange="getproductform();setEndDate()">
                        ...
                        <div class="form-group pull-in clearfix">
                          ...
                          <option value="{{Auth::user()->getBranch()}}">{{Auth::user()->getBranch()}}</option>
                       ...
                       <div class="form-group pull-in clearfix">
                          <div class="col-sm-12">
                            <label>Intermediary's Name</label> 
 ...
 --}}
                         ...
                         <div class="form-group pull-in clearfix">
                          <div class="col-sm-12">
                            ...
                            <select id="account_manager" name="account_manager" rows="3" tabindex="1" data-placeholder="Select here.." style="width:100%">
                        ...
                        <div class="form-group pull-in clearfix">
                          ...
                          <div class="form-group{{ $errors->has('policy_sales_channel') ? ' has-error' : ''}}">
                            ...
                            <select id="policy_sales_channel" data-trigger="change" data-required="true" name="policy_sales_channel" rows="3" tabindex="1" data-placeholder="Select here.." style="width:100%">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group pull-in clearfix">
                          ...
                          <div class="form-group{{ $errors->has('policy_number') ? ' has-error' : ''}}">
                            ...
                            <input id="policy_number" name="policy_number" value="" readonly="true" class="form-control" rows="3" tabindex="1">
                       ...
                       {{--   @foreach($policystatus as $policystatus)
                        <option value="{{ $policystatus->type }}">{{ $policystatus->type }}</option>
                         ...
                         <div class="form-group pull-in clearfix">
                          ...
                          <div class="col-sm-6">
                         <div class="form-group @if($errors->has('commence_date')) has-error @endif">
                        <label for="time">Commencement Date</label>
                        <div class="input-group">
                        <input type="text" class="form-control" onchange="setEndDate()" name="commence_date" id="commence_date" placeholder="Select your time" value="{{ old('expiry_date') }}">
                         <span class="input-group-addon">
                      <span class="fa fa-calendar"></span>
                      </span>
                      </div>
                        @if ($errors->has('commence_date'))
                        <p class="help-block"><span class="glyphicon glyphicon-exclamation-sign"></span> 
                        {{ $errors->first('commence_date') }}
                       </p>
                        @endif
                      </div>    
                        </div>
                        ...
                        <div class="input-group">
                        <input type="text" class="form-control" name="expiry_date" id="expiry_date" placeholder="Select your time" value="{{ old('expiry_date') }}">
                         <span class="input-group-addon">
                      <span class="fa fa-calendar"></span>
                      </span>
                      </div>
...
{{-- 
                      ...
                      <span class="fa fa-calendar"></span>
                        ...
                        <div class="input-group">
                        <input type="text" class="form-control" name="transaction_date" readonly="true" id="transaction_date" placeholder="Select your time" value="{{ old('transaction_date') }}">
                         <span class="input-group-addon">
                      <span class="fa fa-calendar"></span>
                      </span>
                      </div>
                       ...
                       <br>
                        ...
                        <div class="input-group">
                        <input type="text" class="form-control" name="issue_date" id="issue_date" placeholder="Select your time" value="{{ old('issue_date') }}">
                         <span class="input-group-addon">
                      <span class="fa fa-calendar"></span>
                      </span>
                      </div>
                        ...
                        <label for="time">Submission Date / Award Date</label>
                        <div class="input-group">
                        <input type="text" class="form-control" name="acceptance_date" id="acceptance_date" placeholder="Select your time" value="{{ old('acceptance_date') }}">
                         <span class="input-group-addon">
                      <span class="fa fa-calendar"></span>
                      </span>
                      </div>
                    ...
                    <div class="panel panel-default">
                      ...
                      <div id="collapseOne3" class="panel-collapse collapse">
                        ...
                        <div id="policy_upper_text" name="policy_upper_text" class="form-control" style="overflow:scroll;height:300px;max-height:300px" contenteditable="true"> 
                    ...
                    <div class="panel panel-default">
                      ...
                      <div id="collapseTwo3" class="panel-collapse collapse">
                        ...
                        <div id="policy_lower_text" name="policy_lower_text" class="form-control" style="overflow:scroll;height:300px;max-height:300px" contenteditable="true"> 
                    ...
                    <div class="panel panel-default">
                      ...
                      <div id="collapseThree3" class="panel-collapse collapse">
                        ...
                        <div id="policy_end_text" name="policy_end_text" class="form-control" style="overflow:scroll;height:300px;max-height:300px" contenteditable="true"> 
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion3" href="#collapseThree4">
                          Renewal Text
                        </a>
                      </div>
                      <div id="collapseThree3" class="panel-collapse collapse">
                        ...
                        <div id="policy_renewal_text" name="policy_renewal_text" class="form-control" style="overflow:scroll;height:300px;max-height:300px" contenteditable="true"> 
                    ...
                    <div class="panel panel-default">
                     ...
                     <header class="panel-heading font-bold">                  
                      ...
                      <div class="panel-body">
                                ...
                                <div class="col-sm-4">
                            <label>Vehicle Usage <sup class="text-danger"> * </sup> </label> 
                          ...
                          <div class="form-group{{ $errors->has('preferedcover') ? ' has-error' : ''}}">
                            <label>Prefered Cover <sup class="text-danger"> * </sup> </label>
                            <select id="preferedcover" name="preferedcover" onchange="vehicleexiststatus();getCommissionRates(this);getcomprehensiveform()" rows="3" tabindex="1" data-placeholder="Select here.." style="width:100%">
                        ...
                        <option value="Third Party">Third Party</option>
                          ...
                          <div class="col-sm-4">
                            <label>Certificate Type <sup class="text-danger"> * </sup> </label> 
                        ...
                        <div class="col-sm-4">
                            <label>Vehicle Registration Number <sup class="text-danger"> * </sup> </label> 
                        ...
                        <div class="form-group pull-in clearfix">
                          ...
                          <div class="form-group{{ $errors->has('vehicle_make') ? ' has-error' : ''}}">
                            <label>Vehicle Make <sup class="text-danger"> * </sup> </label>
                        ...
                        <option value="{{ $vehiclemake->type }}">{{ $vehiclemake->type }}</option>
                         ...
                         <div class="col-sm-2">
                          <div class="form-group{{ $errors->has('vehicle_model') ? ' has-error' : ''}}">
                            <label>Vehicle Model <sup class="text-danger"> * </sup> </label>
                        ...
                        <option value="{{ $vehiclemodel->type }}">{{ $vehiclemodel->type }}</option>
                          ...
                          <div class="col-sm-2">
                           ...
                           <input type="text" class="form-control" placeholder="eg. XL,CE" id="vehicle_model_description"  value="{{ Request::old('vehicle_model_description') ?: '' }}"  name="vehicle_model_description">
                          ...
                          <div class="form-group{{ $errors->has('vehicle_body_type') ? ' has-error' : ''}}">
                            <label>Body Type <sup class="text-danger"> * </sup> </label>
                        ...
                        <div class="form-group pull-in clearfix">
                          ...
                          <div class="form-group{{ $errors->has('vehicle_make_year') ? ' has-error' : ''}}">
                            <label>Year of Manufacture <sup class="text-danger"> * </sup> </label>
                        ...
                        <option value="{{ $year }}">{{ $year }}</option>
                          ...
                          <div class="col-sm-4">
                            <label>Seating Capacity <sup class="text-danger"> * </sup> </label> 
                        ...
                        <div class="form-group pull-in clearfix">
                           <div class="col-sm-4">
                            <label>Cubic Capacity <sup class="text-danger"> * </sup> </label> 
                        ...
                        <div class="line line-dashed line-lg pull-in"></div>
                          ...
                          <div class="form-group pull-in clearfix">
                           ...
                           <input type="text" class="form-control" id="vehicle_owner_name"  value="{{$customers->fullname}}"  name="vehicle_owner_name">
                    ...
                    <section class="panel panel-default">
                     <header class="panel-heading font-bold">                  
                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group pull-in clearfix">
                          <div class="col-sm-4">
                            <label>Sticker Number <sup class="text-danger"> * </sup> </label> 
                          <select id="sticker_number" name="sticker_number" onchange="stickerexiststatus()" rows="3" tabindex="1" data-placeholder="Select here.. test range (1 - 1000000)" style="width:100%">
                           <option value="">-- select from here --</option>
                          @foreach($stickers as $sticker)
                        <option value="{{ $sticker->sticker_number }}"> {{ $sticker->sticker_number }}</option>
                          @endforeach
                        </select> 
                    ...
                    <section class="panel panel-default">
                     <header class="panel-heading font-bold">                  
                      ...
                      <div class="form-group pull-in clearfix">
                        ...
                        <option value="{{ $unit->type }}">{{ $unit->type }}</option>
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="number" min="0" value="0" step="0.01" value="0" class="form-control" id="liability_si"  value="{{ Request::old('liability_si') ?: '' }}"  name="liability_si">
                      ...
                      <div class="input-group">
                          ...
                          <span class="input-group-btn">
                            <a class="btn btn-info" onclick="addLiabilityDetails()" type="button">+</a>
                          </span>
                        </div>
                        </div>
                     ...
                     <header class="panel-heading font-bold">                  
                      ...
                      <div class="form-group pull-in clearfix">
                        ...
                        <option value="{{ $unit->type }}">{{ $unit->type }}</option>
                          ...
                          <div class="col-sm-4">
                            <label>Sum Insured / Limit </label> 
                           <input type="number" min="0" value="0" step="0.01" value="0" class="form-control" id="accident_si"  value="{{ Request::old('accident_si') ?: '' }}"  name="accident_si">
                      ...
                      <div class="input-group">
                          ...
                          <span class="input-group-btn">
                            <a class="btn btn-info" onclick="addAccidentDetails()" type="button">+</a>
                          </span>
                        </div>
                        </div>
                 ...
                 <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2222" href="#collapse123">
                         <span class="label label-warning">1. Click here to add  Risk Details</span> 
                        </a>
                      </div>
                       ...
                       @foreach($firerisks as $firerisks)
                        ...
                        <option value="{{ $property->type }}">{{ $property->type }}</option>
                          ...
                          <div class="form-group{{ $errors->has('property_number') ? ' has-error' : ''}}">
                            <label>Risk Number</label>
                              <input type="number" class="form-control" id="property_number"  value="{{ Request::old('property_number') ?: '' }}"  name="property_number">
                        ...
                        <div class="col-sm-2">
                          <div class="form-group{{ $errors->has('property_sticker_number') ? ' has-error' : ''}}">
                            <label>Sticker Number</label>
                              <input type="number" class="form-control" id="property_sticker_number"  value="{{ Request::old('property_sticker_number') ?: '' }}"  name="property_sticker_number">
                           @if ($errors->has('property_sticker_number'))
                          <span class="help-block">{{ $errors->first('property_sticker_number') }}</span>
                           @endif    
                          </div>   
                        </div>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2222" href="#collapse34">
                         <span class="label label-primary">2. Click here to add  Item Details</span> 
                        </a>
                      </div>
                  ...
                  <div class="panel wrapper panel-success">
                          <div class="row pull-left">
                            <div class="col-xs-3">
                              <a href="#">
                                <span class="m-b-xs h4 block"><input type="text" value="0" class="form-control"  id="lta" name="lta"></span>
                      ...
                      <div class="panel-body">
                         ...
                         <div class="form-group pull-in clearfix">
                          ...
                          <div class="form-group has-error">
                             ...
                             <option value="">-- select clauses --</option>
                         @foreach($clausetypes as $clausetype)
                        <option value="{{ $clausetype->description }}"> {{$clausetype->type }}</option>
                          @endforeach
                        </select>         
                      ...
                      <section class="panel panel-default">
                       ...
                       <table id="" cellpadding="2" cellspacing="0" border="2" class="table table-striped m-b-none text-sm" width="100%">
                          ...
                          A <input type="text" class="form-control" readonly="true" value="{{ Request::old('owndamage') ?: '' }}" id="owndamage" name="owndamage"> 
                           ...
                           <div class="col-sm-6">
                          E <input type="text" class="form-control" onblur="recomputeMotor()" value="{{ Request::old('owndamage_edit') ?: '' }}" id="owndamage_edit" name="owndamage_edit"> 
                          </div>
                          </td>
                         ...
                         A <input type="text" class="form-control" readonly="true" value="{{ Request::old('tpbasic') ?: '' }}" id="tpbasic" name="tpbasic">
                          ...
                          <div class="col-sm-6">
                         E <input type="text" class="form-control" onblur="recomputeMotor()"  value="{{ Request::old('tpbasic_edit') ?: '' }}" id="tpbasic_edit" name="tpbasic_edit"> 
                         </div> 
                          </td>
                          ...
                          <td>
                           ...
                           <input type="text" class="form-control" onblur="recomputeMotor()" value="{{ Request::old('ccage_edit') ?: '' }}" id="ccage_edit" name="ccage_edit"> 
                           </div>
                          </td>
                          </tr>
                          ...
                          <td>Base Commission (%)</td>
                            <td>
                            <div class="col-sm-12">
                           <input type="text" class="form-control" readonly="true" value="{{ Request::old('commission_rate') ?: '' }}" id="commission_rate" name="commission_rate"> 
                           </div>
                          </td>
                        ...
                        <div id="nonmotorcharges" name="nonmotorcharges">
                          ...
                          <td>Base Commission (%)</td>
                            <td>
                           <input type="text" class="form-control" readonly="true" value="{{ Request::old('commission_rate_2') ?: '' }}" id="commission_rate_2" name="commission_rate_2"> 
                          </td>
                          </tr>
                        ...
                        <button type="button" onclick="generatePolicyNumber();computenonMotorPremium();scrollbackup()" class="btn btn-success btn-lg btn-next" data-target="#form-wizard" data-wizard="next" data-last="Finish">Next</button>
                      </div>     
...
function computenonMotorPremium()
{
    ...
    if($('#policy_product').val() == "Fire Insurance")
    {
     ...
     else if($('#policy_product').val() == "Motor Insurance")
    {



      computePremiumNotStep();
  ...
  else
  {
    $.get('/recompute-motor',
        ...
        { 
          ...
          sweetAlert(data["Premium"], data["Premium"], "info");
...
if($('#gross_premium_2').val()!= 0 && $('#suminsured_2').val()!= 0)
{
    ...
    $.get('/add-non-motor-policy',
        {
          ...
          "account_manager"              :$('#account_manager').val(),
          "commission_rate"              :$('#commission_rate_2').val(),
    ...
    {sweetAlert("Please ensure schedule contain items/values for computations from previous page!");}
  ...
  function loadEngineeringDetails()
   {
        ...
        $.get('/get-engineering-schedule',
          ...
          { 
            ...
            $.each(data, function (key, value) 
            {           
            $('#engineeringScheduleTable tbody').append('<tr><td>'+ value['car_parties'] +'</td><td>'+ value['car_nature_of_business'] +'</td><td>'+ value['car_contract_description'] +'</td><td>'+ thousands_separators(value['car_contract_sum']) +'</td><td>'+ value['car_contract_rate'] +'</td><td>'+ value['created_on'] +'</td><td>'+ value['created_by'] +'</td><td><a a href="#"><i onclick="removeEngineering('+value['id']+')" class="fa fa-trash-o"></i></a></td><td><a href="/print-property/'+value['id']+'">' + '<i onclick="" class="fa fa-print"></i></a></td></tr>');
            });
  ...
  function loadAccidentDetails()
   {
        ...
        $.get('/get-accident-schedule',
          ...
          { 
            ...
            $.each(data, function (key, value) 
            {           
           $('#accidentScheduleTable tbody').append('<tr><td>'+ value['unit'] +'</td><td>'+ thousands_separators(value['sum_insured']) +'</td><td>'+ value['rate'] +'</td><td><a a href="#"><i onclick="removeAccident('+value['id']+')" class="fa fa-trash-o"></i></a></td><td><a href="/print-property/'+value['id']+'">' + '<i onclick="" class="fa fa-print"></i></a></td></tr>');
            });
      ...
      function loadLiabilityDetails()
   {
        ...
        $.get('/get-liability-schedule',
          ...
          { 
            ...
            $.each(data, function (key, value) 
            {           
            $('#liabilityScheduleTable tbody').append('<tr><td>'+ value['risk_type'] +'</td><td>'+ value['unit'] +'</td><td>'+ thousands_separators(value['sum_insured']) +'</td><td>'+ value['rate'] +'</td><td>'+ value['created_on'] +'</td><td>'+ value['created_by'] +'</td><td><a a href="#"><i onclick="removeLiability('+value['id']+')" class="fa fa-trash-o"></i></a></td><td><a href="/print-property/'+value['id']+'">' + '<i onclick="" class="fa fa-print"></i></a></td></tr>');
            });
    ...
    function loadProperties()
   {
        ...
        $.get('/get-fire-property',
          ...
          { 
            ...
            $.each(data, function (key, value) 
            {           
            $('#fireRiskTable tbody').append('<tr><td>'+ value['risk_number'] +'</td><td>'+ value['item_number'] +'</td><td>'+ value['property_type'] +'</td><td>'+ value['property_description'] +'</td><td>'+ thousands_separators(value['item_value']) +'</td><td>'+ value['rate'] +'</td><td>'+ thousands_separators(value['actual_premium']) +'</td><td>'+ value['created_on'] +'</td><td>'+ value['created_by'] +'</td><td><a a href="#"><i onclick="removeProperty('+value['id']+')" class="fa fa-trash-o"></i></a></td><td><a href="/print-property/'+value['id']+'">' + '<i onclick="" class="fa fa-print"></i></a></td></tr>');
            });
...
$(function () {
   $('#expiry_date').daterangepicker({
    "minDate": moment(),
    "maxDate": moment().add(1, 'years').subtract(1, 'days'),
...
function  getcomprehensiveform() 
{
  ...
  //alert($('#policy_product').val());
   if( $('#preferedcover').val() == "Comprehensive")
    ...
    {
      $('#vehicle_buy_back_excess').val('No');
      $('#motorinsurancecomprehensive').hide();
  ...
  else
  {
    $.get('/compute-motor',
        ...
        { 
          ...
          sweetAlert("Premium : "+  $('#policy_currency').val() + ' ' + thousands_separators(data["Premium"]),'', "info");
          $('#gross_premium').val(data.gross_premium);
          $('#premium_due_motor').val(data.Premium);
...
{
  //sweetAlert("No Premium Computed", 0, "info");
}
...
function stickerexiststatus()
    {
      ...
      $.get('/get-sticker-availability',
        ...
        {
          $('#sticker_number').val('');
          sweetAlert("Sticker "+ $('#sticker_number').val() +" is not available in the system or has been used!");
          $('#sticker_number').val('');
        }
      });
      ...
      function loadIntermediary()
   {
        ...
        $.get('/load-intermediary',
          ...
          { 
            ...
            $.each(data, function () 
            {           
            $('#agency').append($('<option></option>').val(this['agentcode']).html(this['agentname']));
            });
