              ...
              <div class="line"></div>
               ...
               <p> <strong>Premium</strong></p>
                 ...
                 <div class="row">
                  ...
                  <p>  <strong> Basic Annual Premium : </strong>{{ $policydetails->policy_currency }} {{ number_format($fetchrecord->sum('premium_payable'), 2, '.', ',') }} </p>
                  <p>  <strong> Total Annual Premium : </strong>{{ $policydetails->policy_currency }} {{ number_format($fetchrecord->sum('premium_payable'), 2, '.', ',')  }} </p>
                ...
                <div class="col-xs-4 text-right">
                 ...
                 <p>  <strong> Premium Due : </strong>{{ $policydetails->policy_currency }} {{ number_format($fetchrecord->sum('premium_due'), 2, '.', ',')  }} </p>
                  <p>   <a href="#" class="h4"><strong> Total Due : </strong>{{ $policydetails->policy_currency }} {{ number_format($fetchrecord->sum('premium_due'), 2, '.', ',')  }}</a> </p>
               ...
               <div class="line"></div>
                ...
                <tbody>
                 @foreach($fetchrecord as $keys => $item )
                  <tr>
                    <td colspan="0" class="text-left no-border"> Risk No. {{ ++$keys }} <br>
                    Conveyance : {{ $item->marine_means_of_conveyance }}
                    <br>
                    Voyage : {{ $item->marine_voyage }}
                     </td>
                 ...
                 @endforeach
                  ...
                  <tr>
                    ...
                    <td colspan="3" class="text-right" style="font-size:10px"><strong>Total Sum Insured {{ $policydetails->policy_currency }} {{ number_format($fetchrecord->sum('marine_sum_insured'), 2, '.', ',')}} </strong></td>
                  </tr> 
                  <tr>
                    <td colspan="3" class="text-right" style="font-size:10px"><strong></strong></td>
                    <td colspan="3" class="text-right" style="font-size:10px">Basic Annual Premium {{ $policydetails->policy_currency }} {{ number_format($fetchrecord->sum('premium_payable'), 2, '.', ',') }}</td>
                  </tr>
                  ...
                  <tr>
                    <td colspan="3" class="text-right" style="font-size:10px"><strong></strong></td>
                    <td colspan="3" class="text-right" style="font-size:10px"><strong>Premium Due {{ $policydetails->policy_currency }} {{  number_format(($fetchrecord->sum('premium_due') - 0), 2, '.', ',') }}</strong></td>
                  </tr>
                </tbody>
              </table> 
