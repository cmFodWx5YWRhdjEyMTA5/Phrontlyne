                ...
                <tbody>
                 @foreach($fetchrecord as $keys => $item )
                  <tr>
                    ...
                    <td class="text-left no-border">{{ $item->bond_contract_description }}</td>
                 ...
                 @endforeach
                  ...
                  <tr>
                    ...
                    <td colspan="3" class="text-right" style="font-size:10px"><strong>Total Sum Insured {{ $policydetails->policy_currency }} {{ number_format($fetchrecord->sum('bond_sum_insured'), 2, '.', ',')}} </strong></td>
                  </tr> 
                  <tr>
                    <td colspan="3" class="text-right" style="font-size:10px"><strong></strong></td>
                    <td colspan="3" class="text-right" style="font-size:10px">Basic Annual Premium {{ $policydetails->policy_currency }} {{ number_format($fetchrecord->sum('annual_premium'), 2, '.', ',') }}</td>
                  </tr>
                  ...
                  <tr>
                    <td colspan="3" class="text-right" style="font-size:10px"><strong></strong></td>
                    <td colspan="3" class="text-right" style="font-size:10px"><strong>Premium Due {{ $policydetails->policy_currency }} {{  number_format(($fetchrecord->sum('annual_premium') - 0), 2, '.', ',') }}</strong></td>
                  </tr>
                </tbody>
              </table> 
