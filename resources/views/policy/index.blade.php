              ...
              <section class="panel panel-default">
                <div class="row m-l-none m-r-none bg-light lter">
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                   <img src="/images/1104149.svg" width="15%"  class="pull-left">
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong>{{ $policies->total() }}</strong></span>
                      <small class="text-muted text-uc">Filed Policy</small>
                    </a>
                   
                  </div>
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                     <img src="/images/1102457.svg" width="15%" class="pull-left">
                    </span>
                    <a class="clear" href="#">
                 ...
                 <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                   <img src="/images/134900.svg" width="15%" class="pull-left">
                  ...
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                     <img src="/images/148930.svg" width="15%" class="pull-left">
                      ...
                      <table class="table table-striped m-b-none text-sm" width="100%">
                        ...
                        @endif
                           ...
                           <td><a href="/view-policy/{{ $policy->policy_number }}" class="text-info">{{ $policy->master_policy_number }}</a></td>
                            ...
                            <td>{{Carbon\Carbon::parse($policy->insurance_period_from )->format('d-m-Y') }} to {{ Carbon\Carbon::parse($policy->insurance_period_to )->format('d-m-Y') }} <span class="label label-default"></span></td>
                            ...
                            <td>{{ $policy->policy_product }}</td>
                             ...
                             @endif
                                ...
                                <td>
                            <a href="/view-policy/{{ $policy->policy_number }}" class="bootstrap-modal-form-open"  data-toggle="tooltip" data-placement="top" title="" data-original-title="Click to view policy"  id="edit" name="edit" data-toggle="modal" alt="edit"><i class="fa fa-folder-open"></i></a>
                             </td>
                            ...
                            <a href="/edit-policy/{{ $policy->id }}" class="bootstrap-modal-form-open"   id="edit" name="edit" data-toggle="modal" alt="edit"><i class="fa fa-pencil"></i></a>
                              ...
                              <td>
                            <a href="#" onClick="removePolicy('{{ $policy->id }}','{{ $policy->policy_number }}')"><i class="fa fa-trash"></i></a>
                             </td> 
                             @else
