              ...
              <section class="panel panel-default">
                <div class="row m-l-none m-r-none bg-light lter">
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                   <img src="/images/1087813.svg" width="15%"  class="pull-left">
                    <a class="clear" href="#">
                  ...
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                     <img src="/images/1087806.svg" width="15%" class="pull-left">
                    </span>
                    <a class="clear" href="#">
                 ...
                 <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                   <img src="/images/1087807.svg" width="15%" class="pull-left">
                  ...
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                    ...
                    <a class="clear" href="/print-renewal-bulk">
                      <span class="h3 block m-t-xs"><strong id="bugs">0</strong></span>
                      <small class="text-muted text-uc">Print Bulk Report</small>
                    </a>
                  </div>
                </div>
              </section>
