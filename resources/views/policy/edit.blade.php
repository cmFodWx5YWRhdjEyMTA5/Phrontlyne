...
<section id="content">
          <section class="vbox">          
            <section class="scrollable padder">
              ...
              <p class="h4 text-dark"><strong>Edit Policy : {{ $policy->fullname }} ( {{ $policy->account_number }} )</strong></p>
            </header>
                    ...
                    {{-- Step 2 Start --}}
                     ...
                     <header class="panel-heading font-bold">                  
                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group pull-in clearfix">
                          ...
                          <div class="form-group{{ $errors->has('policy_number') ? ' has-error' : ''}}">
                            ...
                            <input id="policy_number" name="policy_number" value="{{ $policy->policy_number }}" readonly="true" class="form-control" rows="3" tabindex="1">
                             ...
                             <input type="hidden" id="old_coverage" name="old_coverage" value="{{ $policy->coverage }}" readonly="true" class="form-control" rows="3" tabindex="1">
                        ...
                        <div class="input-group">
                        <input type="text" class="form-control" onchange="setEndDate()" name="commence_date" id="commence_date" placeholder="Select your time" value="{{ $policy->insurance_period_from->format('d-m-Y i') }}">
                      ...
                      <span class="fa fa-calendar"></span>
                        ...
                        <div class="input-group">
                        <input type="text" class="form-control" name="expiry_date" id="expiry_date" placeholder="Select your time" value="{{ $policy->insurance_period_to->format('d-m-Y i') }}">
                         <span class="input-group-addon">
                      <span class="fa fa-calendar"></span>
                      </span>
                      </div>
...
{{-- 
                      ...
                      <span class="fa fa-calendar"></span>
                       ...
                       <br>
                        ...
                        <div class="input-group">
                        <input type="text" class="form-control" name="issue_date" id="issue_date" placeholder="Select your time" value="{{ $policy->first_issue_date->format('d-m-Y i') }}">
                         <span class="input-group-addon">
                      <span class="fa fa-calendar"></span>
                      </span>
                      </div>
                        ...
                        <div class="input-group">
                        <input type="text" class="form-control" name="acceptance_date" id="acceptance_date" placeholder="Select your time" value="{{ $policy->acceptance_date->format('d-m-Y i') }}">
                         <span class="input-group-addon">
                      <span class="fa fa-calendar"></span>
                      </span>
                      </div>
                    ...
                    <div class="panel panel-default">
                      ...
                      <div id="collapseThree3" class="panel-collapse collapse">
                        ...
                        <div id="policy_renewal_text" name="policy_renewal_text" class="form-control" style="overflow:scroll;height:300px;max-height:300px" contenteditable="true"> {!! $policy->policy_renewal_text !!} 
                    ...
                    <div class="panel panel-default">
                     ...
                     <header class="panel-heading font-bold">                  
                      ...
                      <div class="panel-body">
                       ...
                       <option value="{{ $fetchrecord->vehicle_cover }}">{{ $fetchrecord->vehicle_cover }}</option>
                        ...
                        <option value="Third Party">Third Party</option>
                          ...
                          <option value="{{ $fetchrecord->vehicle_risk }}">{{ $fetchrecord->vehicle_risk }}</option>
                        ...
                        <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="vehicle_registration_number" onblur="vehicleexiststatus()"  value="{{ $fetchrecord->vehicle_registration_number ?: '' }}"  name="vehicle_registration_number">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="number" min="0" step="0.01" class="form-control" id="vehicle_value"  value="{{ $fetchrecord->vehicle_value }}"  name="vehicle_value">
                         ...
                         <option value="{{ $fetchrecord->vehicle_buy_back_excess}}">{{ $fetchrecord->vehicle_buy_back_excess }}</option>
                        ...
                        <div class="form-group pull-in clearfix">
                          ...
                          <div class="form-group{{ $errors->has('vehicle_make') ? ' has-error' : ''}}">
                            ...
                            <select id="vehicle_make" name="vehicle_make" rows="3" tabindex="1" data-placeholder="Select here.." style="width:100%" onchange="loadModels()">
                             <option value="{{ $fetchrecord->vehicle_make}}">{{ $fetchrecord->vehicle_make }}</option>
                         ...
                         <div class="col-sm-2">
                          <div class="form-group{{ $errors->has('vehicle_model') ? ' has-error' : ''}}">
                            ...
                            <select id="vehicle_model" name="vehicle_model" rows="3" tabindex="1" data-placeholder="Select here.." style="width:100%">
                             <option value="{{ $fetchrecord->vehicle_model}}">{{ $fetchrecord->vehicle_model }}</option>
                        ...
                        <option value="{{ $vehiclemodel->type }}">{{ $vehiclemodel->type }}</option>
                          ...
                          <div class="col-sm-2">
                           ...
                           <input type="text" class="form-control" placeholder="eg. XL,CE" id="vehicle_model_description"  value="{{ $fetchrecord->vehicle_model_description }}"  name="vehicle_model_description">
                          ...
                          <option value="{{ $fetchrecord->vehicle_body_type}}">{{ $fetchrecord->vehicle_body_type }}</option>
                        ...
                        <div class="form-group pull-in clearfix">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="number" min="2000" max="20000" value="{{ $fetchrecord->vehicle_tppdl_value }}" step="1" class="form-control" id="vehicle_tppdl_value" name="vehicle_tppdl_value">
                          ...
                          <div class="form-group{{ $errors->has('vehicle_make_year') ? ' has-error' : ''}}">
                            ...
                            <select id="vehicle_make_year" name="vehicle_make_year" rows="3" tabindex="1" data-placeholder="Select here.." style="width:100%">
                             <option value="{{ $fetchrecord->vehicle_make_year}}">{{ $fetchrecord->vehicle_make_year }}</option>
                        ...
                        <option value="{{ $year }}">{{ $year }}</option>
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="number" min="0" max="100" value="{{ $fetchrecord->vehicle_seating_capacity }}" step="1" class="form-control" id="vehicle_seating_capacity"  name="vehicle_seating_capacity">
                        ...
                        <div class="form-group pull-in clearfix">
                           ...
                           <input type="number" min="0" max="10000" value="{{ $fetchrecord->vehicle_cubic_capacity }}" step="1" class="form-control" id="vehicle_cubic_capacity" name="vehicle_cubic_capacity">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="vehicle_engine_number"  value="{{ $fetchrecord->vehicle_engine_number }}"  name="vehicle_engine_number">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="vehicle_chassis_number"  value="{{ $fetchrecord->vehicle_chassis_number }}"  name="vehicle_chassis_number">
                        ...
                        <div class="line line-dashed line-lg pull-in"></div>
                          ...
                          <div class="form-group pull-in clearfix">
                           ...
                           <input type="text" class="form-control" id="vehicle_owner_name"  value="{{ $fetchrecord->vehicle_owner_name }}"  name="vehicle_owner_name">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="license_number"  value="{{ $fetchrecord->license_number }}"  name="license_number">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="vehicle_register_date"  value="{{ $fetchrecord->vehicle_register_date }}"  name="vehicle_register_date">
                        ...
                        <div class="line line-dashed line-lg pull-in"></div>
                          ...
                          <div class="form-group pull-in clearfix">
                           ...
                           <input type="number" class="form-control" id="vehicle_log_book"  value="{{ $fetchrecord->vehicle_log_book }}"  name="vehicle_log_book">
                          ...
                          <span class="help-block">{{ $errors->first('vehicle_log_book') }}</span>
                           ...
                           <div class="col-sm-4">
                            <label>Colour</label> 
                           <input type="text" class="form-control" id="vehicle_colour"  value="{{ $fetchrecord->vehicle_colour }}"  name="vehicle_colour">
                          ...
                          <div class="col-sm-4">
                            <label>Model Description</label> 
                           <input type="text" class="form-control" id="vehicle_model_description"  value="{{ $fetchrecord->vehicle_model_description }}"  name="vehicle_model_description">
                          @if ($errors->has('vehicle_mileage_number'))
                          <span class="help-block">{{ $errors->first('vehicle_model_description') }}</span>
                           @endif   
                          </div>
                        ...
                        <div class="line line-dashed line-lg pull-in"></div>
                          ...
                          <div class="form-group pull-in clearfix">
                           ...
                           <input type="number" class="form-control" id="vehicle_tonnage_capacity"  value="{{ $fetchrecord->vehicle_tonnage_capacity }}"  name="vehicle_tonnage_capacity">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="vehicle_trailer_number"  value="{{ $fetchrecord->vehicle_trailer_number }}"  name="vehicle_trailer_number">
                          ...
                          <div class="col-sm-4">
                            <label>Mileage</label> 
                           <input type="number" class="form-control" id="vehicle_mileage_number"  value="{{ $fetchrecord->vehicle_mileage_number  }}"  name="vehicle_mileage_number">
                          @if ($errors->has('vehicle_mileage_number'))
                        ...
                        <div class="line line-dashed line-lg pull-in"></div>
                         ...
                         <div class="form-group pull-in clearfix">
                           ...
                           <input type="number" class="form-control" id="vehicle_purchase_price"  value="{{ $fetchrecord->vehicle_purchase_price }}"  name="vehicle_purchase_price">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="vehicle_lta_upload"  value="{{ optional($fetchrecord->vehicle_lta_upload)->format('d-m-Y i')  }}"  name="vehicle_lta_upload">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="vehicle_lta_transmission"  value="{{ optional($fetchrecord->vehicle_lta_transmission)->format('d-m-Y i')   }}"  name="vehicle_lta_transmission">
                     ...
                     <header class="panel-heading font-bold">                  
                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group pull-in clearfix">
                           ...
                           <input type="number" class="form-control" id="sticker_number"  value="{{ $fetchrecord->sticker_number }}"  name="sticker_number">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="certificate_number"  value="{{ $fetchrecord->certificate_number  }}"  name="certificate_number">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="brown_card_number"  value="{{ $fetchrecord->brown_card_number }}"  name="brown_card_number">
                       ...
                       <div class="form-group pull-in clearfix">
                         ...
                         <div class="col-sm-6">
                          ...
                          <select id="vehicle_ncd" name="vehicle_ncd" rows="3" tabindex="1" data-placeholder="Select here.." style="width:100%">
                           <option value="{{ $fetchrecord->vehicle_ncd }}">{{ $fetchrecord->vehicle_ncd }}</option>
                        ...
                        <option value="{{ $noclaimdiscount->rate }}">{{ $noclaimdiscount->type }}</option>
                          ...
                          <div class="form-group{{ $errors->has('vehicle_fleet_discount') ? ' has-error' : ''}}">
                            ...
                            <select id="vehicle_fleet_discount" name="vehicle_fleet_discount" rows="3" tabindex="1" data-placeholder="Select here.." style="width:100%">
                             <option value="{{ $fetchrecord->vehicle_fleet_discount }}">{{ $fetchrecord->vehicle_fleet_discount }}</option>
...
{{-- 
                       ...
                       <table id="" cellpadding="2" cellspacing="0" border="2" class="table table-striped m-b-none text-sm" width="100%">
                        ...
                        <button type="button" onclick="computenonMotorPremium();" class="btn btn-success btn-lg btn-next" data-target="#form-wizard" data-wizard="next" data-last="Finish">Next</button>
                      </div>     
