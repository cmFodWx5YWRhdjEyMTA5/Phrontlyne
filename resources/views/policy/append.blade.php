            ...
            <section class="scrollable padder">
              <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li class=""> Policy Administration </li>
                 <li class="active"> Fleet Policy </li>   
              </ul>

              <header class="header bg-white b-b b-light">
              <p class="h4 text-dark"><strong>Fleet Policy : {{ $policy->fullname }} ( {{ $policy->account_number }} )</strong></p>
            </header>
                      ...
                      <div class="panel-body">
                       ...
                       <option value="{{ $fetchrecord->vehicle_cover }}">{{ $fetchrecord->vehicle_cover }}</option>
                        ...
                        <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="vehicle_registration_number" onblur="vehicleexiststatus()"  value=""  name="vehicle_registration_number">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="number" min="0" step="0.01" class="form-control" id="vehicle_value"  value=""  name="vehicle_value">
                        ...
                        <option value="{{ $vehiclemodel->type }}">{{ $vehiclemodel->type }}</option>
                          ...
                          <div class="col-sm-2">
                           ...
                           <input type="text" class="form-control" placeholder="eg. XL,CE" id="vehicle_model_description"  value=""  name="vehicle_model_description">
                        ...
                        <div class="form-group pull-in clearfix">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="vehicle_engine_number"  value=""  name="vehicle_engine_number">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="vehicle_chassis_number"  value=""  name="vehicle_chassis_number">
                        ...
                        <div class="line line-dashed line-lg pull-in"></div>
                          ...
                          <div class="form-group pull-in clearfix">
                           ...
                           <input type="text" class="form-control" id="vehicle_owner_name"  value=""  name="vehicle_owner_name">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="license_number"  value=""  name="license_number">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="vehicle_register_date"  value=""  name="vehicle_register_date">
                        ...
                        <div class="line line-dashed line-lg pull-in"></div>
                          ...
                          <div class="form-group pull-in clearfix">
                           ...
                           <input type="number" class="form-control" id="vehicle_log_book"  value=""  name="vehicle_log_book">
                          ...
                          <span class="help-block">{{ $errors->first('vehicle_log_book') }}</span>
                           ...
                           <div class="col-sm-4">
                            <label>Colour</label> 
                           <input type="text" class="form-control" id="vehicle_colour"  value=""  name="vehicle_colour">
                          ...
                          <div class="col-sm-4">
                            <label>Model Description</label> 
                           <input type="text" class="form-control" id="vehicle_model_description"  value=""  name="vehicle_model_description">
                          @if ($errors->has('vehicle_mileage_number'))
                          <span class="help-block">{{ $errors->first('vehicle_model_description') }}</span>
                           @endif   
                          </div>
                        ...
                        <div class="line line-dashed line-lg pull-in"></div>
                          ...
                          <div class="form-group pull-in clearfix">
                           ...
                           <input type="number" class="form-control" id="vehicle_tonnage_capacity"  value=""  name="vehicle_tonnage_capacity">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="vehicle_trailer_number"  value=""  name="vehicle_trailer_number">
                          ...
                          <div class="col-sm-4">
                            <label>Mileage</label> 
                           <input type="number" class="form-control" id="vehicle_mileage_number"  value=""  name="vehicle_mileage_number">
                          @if ($errors->has('vehicle_mileage_number'))
                        ...
                        <div class="line line-dashed line-lg pull-in"></div>
                         ...
                         <div class="form-group pull-in clearfix">
                           ...
                           <input type="number" class="form-control" id="vehicle_purchase_price"  value=""  name="vehicle_purchase_price">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="vehicle_lta_upload"  value=""  name="vehicle_lta_upload">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="vehicle_lta_transmission"  value=""  name="vehicle_lta_transmission">
                     ...
                     <header class="panel-heading font-bold">                  
                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group pull-in clearfix">
                           ...
                           <input type="number" class="form-control" id="sticker_number"  value=""  name="sticker_number">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="certificate_number"  value=""  name="certificate_number">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="brown_card_number"  value=""  name="brown_card_number">
