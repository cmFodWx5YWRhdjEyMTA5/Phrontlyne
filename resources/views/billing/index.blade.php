        ...
        <section id="content">
          <section class="hbox stretch">
            <aside class="aside-md bg-white b-r" id="subNav">
              ...
              <li class="b-b b-light"><a href="/patient-enquiry"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Patient Enquiry</a></li>
                        ...
                        @foreach($bills as $bill )
                          <tr>
                            ...
                            <td>{{ $bill->amount }}</td>
                             ...
                             <td>
                             @if($bill->note=="Paid")
                             <a href="/billing-invoice/{{ $bill->visit_id }}" class="btn btn-s-md btn-success btn-rounded bootstrap-modal-form-open"  id="edit" name="edit" data-toggle="modal" alt="edit">Paid</a>
                             @else
                               <a href="/billing-invoice/{{ $bill->visit_id }}" class="btn btn-s-md btn-danger btn-rounded bootstrap-modal-form-open"  id="edit" name="edit" data-toggle="modal" alt="edit">Make Payment</a>
                            @endif
                             </td>
