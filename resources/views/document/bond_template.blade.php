...
<form method="post" action="/add-bond-template">
 ...
 <textarea id="bond_template" name="bond_template">  </textarea>
 <br>
 <br>
 <br>
...
<script src="{{ asset('/js/tinymce/tinymce.min.js')}}"></script>
 ...
 <script>tinymce.init({
  ...
  templates: [
    ...
    {title: 'Exp Bond', description: 'Exportation Bond', url: 'http://127.0.0.1:8000/bond-test/5'}
  
  ],
  template_replace_values: {
    bond_number: "{{ $policy->master_policy_number }}",
