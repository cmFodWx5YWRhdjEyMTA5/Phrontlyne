                    ...
                    <div class="table-responsive">
                     ...
                     <table class="table table-striped m-b-none text-sm" width="100%">
                        ...
                        <tbody>
                            ...
                            @foreach($issuedstickers as $item)
...
<i class="fa fa-plus my-float"></i><i class="fa fa-file my-float"></i>
                  ...
                  <div class="row text-center-xs">
                    <div class="col-md-6 hidden-sm">
                      ...
                      <span class="badge badge-info">Record(s) Found : {{ $issuedstickers->total() }} {{ str_plural('Sticker', $issuedstickers->total()) }}</span>
                      </p>
                    </div>
                    <div class="col-md-6 col-sm-12 text-right text-center-xs">                
                     
                      {!!$issuedstickers->render()!!} 
