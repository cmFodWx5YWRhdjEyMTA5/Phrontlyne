    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
      <div class="navbar-header aside-md">
        ...
        <a href="#" class="navbar-brand" data-toggle="fullscreen"><img src="/images/logo3.png" class="m-r-sm"> Phrontlyne </a>
      ...
      <ul class="nav navbar-nav hidden-xs">
        <li class="dropdown">
          <a href="#" class="dropdown-toggle dker" data-toggle="dropdown">
            ...
            <span class="font-bold">User Activity</span>
          </a>@if(Auth::check()) 
            ...
            <div class="row m-l-none m-r-none m-b-n-xs text-center">
              <div class="col-xs-4">
                <div class="padder-v">
                  ...
                  <small class="text-muted">Approved Policies</small>
                </div>
              </div>
              <div class="col-xs-4 dk">
                <div class="padder-v">
                  <span class="m-b-xs h4 block text-white">55</span>
                  <small class="text-muted">Approved Debits</small>
                </div>
              </div>
              <div class="col-xs-4">
                <div class="padder-v">
      ...
      <ul class="nav navbar-nav hidden-xs">
        <li class="dropdown">
          <a href="#" class="dropdown-toggle dker" data-toggle="dropdown">
            ...
            <span class="font-bold">Exchange Rates</span>
          </a>
          <section class="dropdown-menu aside-xl on animated fadeInLeft no-borders lt">
            ...
            <div class="row m-l-none m-r-none m-b-n-xs text-center">
              <div class="col-xs-4">
                <div class="padder-v">
                  <span class="m-b-xs h4 block text-white">4.5</span>
                  <small class="text-muted">USD</small>
                </div>
              </div>
              <div class="col-xs-4 dk">
                <div class="padder-v">
                  <span class="m-b-xs h4 block text-white">5.5</span>
                  <small class="text-muted">EUR</small>
                </div>
              </div>
              <div class="col-xs-4">
                <div class="padder-v">
                  <span class="m-b-xs h4 block text-white">6</span>
      ...
      <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            {{ Auth::user()->getNameOrUsername() }} @  {{ Auth::user()->getBranch() }}<b class="caret"></b>
          </a>
